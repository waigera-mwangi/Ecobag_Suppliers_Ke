    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_type', models.CharField(choices=[('DR', 'Driver'), ('FM', 'Finance Manager'), ('SM', 'Inventory Manager'), ('RD', 'Supplier'), ('CM', 'Customer'), ('MN', 'Manager'), ('BR', 'Brander'), ('DM', 'Dispatch Manager'), ('AD', 'Admin')], default='CM', max_length=2)),
                ('first_name', models.CharField(max_length=250)),
                ('last_name', models.CharField(max_length=250)),
                ('phone_number', accounts.models.CustomPhoneNumberField(max_length=128, region=None, unique=True)),
